...
const stripePromise = loadStripe('pk_test_51QVKDm08RQlkvpcvyCBavyJ7JnIjJRmTsdwhSdAg8YKKxJBDGq7qnUkde5ASwvmiI2AHIQ7dpl0sQIGLWHsTsdZJ00IYeLGTHe');
  ...
  return (
    <div className='p-4 mt-16 max-w-[1400px] mx-auto'>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6'>
            {cartItems.map((item, index) => (
                <div key={index} className='bg-white rounded-lg shadow-lg p-4 flex flex-col'>
                    ...
                    <p className='text-md mb-1'>Price: BDT {(item.priceInCents).toFixed(2)}</p>
        ...
        <div className='text-center mt-8'>
            <p className='text-2xl font-semibold mb-4'>Total Price: BDT {(totalPrice).toFixed(2)}</p>
